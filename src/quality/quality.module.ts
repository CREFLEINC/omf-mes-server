...
import { ReworkWorkOrderService } from './disposition/rework-work-order.service';
...
@Module({
  ...
  controllers: [
    ...
    // `nonconformances`(목록 · I-21 PR ①a) · `nonconformances/:nonconformanceId`(상세 · ①b) ·
