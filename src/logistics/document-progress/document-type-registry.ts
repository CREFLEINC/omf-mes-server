...
export const DOCUMENT_TYPES: Record<LogisticsDocumentType, DocumentTypeMapping> = {
  PURCHASE_ORDER: { entityTypeCode: 'PURCHASE_ORDER', delegate: 'purchase_order', idColumn: 'purchase_order_id',
    ...
    plannedColumn: 'ordered_qty', processedColumn: 'received_qty', subTypeColumn: null, cancelable: false, cancelledStatus: null, derivedFrom: null },
  INBOUND_RECEIPT: { entityTypeCode: 'INBOUND_RECEIPT', delegate: 'inbound_receipt', idColumn: 'inbound_receipt_id',
    ...
    plannedColumn: null, processedColumn: 'received_qty', subTypeColumn: null, cancelable: true, cancelledStatus: null, derivedFrom: null },
  GOODS_RECEIPT: { entityTypeCode: 'GOODS_RECEIPT', delegate: 'goods_receipt', idColumn: 'goods_receipt_id',
    ...
    plannedColumn: 'expected_qty', processedColumn: 'receipt_qty', subTypeColumn: 'receipt_type_code', cancelable: true, cancelledStatus: 'CANCELLED', derivedFrom: null },
  MATERIAL_ISSUE_REQUEST: { entityTypeCode: 'MATERIAL_ISSUE_REQUEST', delegate: 'material_issue_request', idColumn: 'material_issue_request_id',
    ...
    plannedColumn: 'requested_qty', processedColumn: 'issued_qty', subTypeColumn: null, cancelable: false, cancelledStatus: null, derivedFrom: null },
  PICKING_ORDER: { entityTypeCode: 'PICKING_ORDER', delegate: 'picking_order', idColumn: 'picking_order_id',
    ...
    plannedColumn: 'planned_qty', processedColumn: 'picked_qty', subTypeColumn: null, cancelable: false, cancelledStatus: null, derivedFrom: null },
  STOCK_TRANSFER: { entityTypeCode: 'STOCK_TRANSFER', delegate: 'stock_transfer', idColumn: 'stock_transfer_id',
    ...
    plannedColumn: 'requested_qty', processedColumn: 'received_qty', subTypeColumn: null, cancelable: false, cancelledStatus: null, derivedFrom: null },
  SUBCONTRACT_ISSUE: { entityTypeCode: 'SUBCONTRACT_ISSUE', delegate: 'subcontract_issue', idColumn: 'subcontract_issue_id',
    ...
    plannedColumn: null, processedColumn: null, subTypeColumn: null, cancelable: false, cancelledStatus: null, derivedFrom: 'goods_issue' },
  SUBCONTRACT_RECEIPT: { entityTypeCode: 'SUBCONTRACT_RECEIPT', delegate: 'subcontract_receipt', idColumn: 'subcontract_receipt_id',
    ...
    plannedColumn: null, processedColumn: null, subTypeColumn: null, cancelable: false, cancelledStatus: null, derivedFrom: 'goods_receipt' },
  GOODS_ISSUE: { entityTypeCode: 'GOODS_ISSUE', delegate: 'goods_issue', idColumn: 'goods_issue_id',
    ...
    plannedColumn: null, processedColumn: 'issue_qty', subTypeColumn: 'issue_type_code', cancelable: true, cancelledStatus: 'CANCELLED', derivedFrom: null },
};
