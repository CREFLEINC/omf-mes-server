...
export class DepartmentController {
  ...
  update(@Param('departmentCode') departmentCode: string, @Body() dto: UpdateDepartmentDto) {
    return this.service.update(departmentCode, dto);
  }
  ...
  deactivate(@Param('departmentCode') departmentCode: string) {
    return this.service.deactivate(departmentCode);
  }
}
...
export class WorkerController {
  ...
  update(@Param('workerNo') workerNo: string, @Body() dto: UpdateWorkerDto) {
    return this.service.update(workerNo, dto);
  }

  @Delete(':workerNo')
  @HttpCode(HttpStatus.NO_CONTENT)
  @ApiOperation({ summary: '작업자 비활성화 (퇴직 처리 등)' })
  deactivate(@Param('workerNo') workerNo: string) {
    return this.service.deactivate(workerNo);
  }
  ...
  addQualification(@Param('workerNo') workerNo: string, @Body() dto: CreateQualificationDto) {
    return this.service.addQualification(workerNo, dto);
  }
