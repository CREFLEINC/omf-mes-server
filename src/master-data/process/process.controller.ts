...
export class ProcessController {
  ...
  update(@Param('processCode') processCode: string, @Body() dto: UpdateProcessDto) {
    return this.service.update(processCode, dto);
  }
  ...
  deactivate(@Param('processCode') processCode: string) {
    return this.service.deactivate(processCode);
  }
}
