/**
 * 검사 집계 3 + 측정치 목록 (e2e) — I-19 **PR ⑤**. `summary` · `defect-rate-trend` ·
 * `measurement-summary` · `/measurements` 넷과, 그 넷이 처음 세운 판정(`calibration.ts`)을 목록
 * (`GET /quality/inspection-results`)이 되쓰는 자리(#298 m-1)까지 본다.
 *
