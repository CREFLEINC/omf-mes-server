...
⛔ 남의 대역은 빌려 쓰지 않는다(150~179 는 A2 몫이고 ⭐ **둘째 대역 `210~239` 도 A2 몫**이다 — 위 §1-1 A2 행 · 2026-09-09 배정). 레인 A 는 **이미 209 까지 소진**했으므로(실재 180~186 · 188~209 · ⚠ **빈 자리는 187 하나**) **다음 번호가 곧 210 = A2 대역**이다. ⇒ 또 다른 대역이 필요하면 **`240~`** 으로 이어 붙인다.
