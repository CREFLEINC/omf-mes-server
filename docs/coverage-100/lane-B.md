...
| 2 | **I-32** 비가동 | 6(진행5·보류1) | I-11(끝남)·I-30 날짜helper(끝남) — **1과 동시 가능** | remarks/최초사번/version 추가3·type완화1, 조건부종료사번1 | µs 준비/물리/조회/쓰기·summary 분리 | P0t+P1a/P1b+P2~P4, summary 후속, close109 대기 |
...
| 7 | **I-28** 알림 | 8(전건 진행) | I-1(끝남) — 언제든 · **6과 동시 가능** | 지금0 · A7·A8은 서버결정 후 적용 | 조회/쓰기 분리 | 구현5 + 이벤트·구독3 후속 |
