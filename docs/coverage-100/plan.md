...
**현재 목표 커버리지 479/487**(당초483 − I-28 본길 보류3 − I-30 완료 보류1). 배정/분모487은 불변이며 보류 해소 때 해당 증분만 복원한다. 최신 main 실측은 진행 기록과 병합 SHA로 구분한다(2026-09-07 b11cdf0:346/487).
...
| I-28 | 진행 중 · 2026-09-07 | #290(계획 R-1~R-10) · #295(① 알림 조회2, b11cdf0) MERGED. #299(② 단건·모두 읽음2) 검증·독립 리뷰 완료, 병합 대기. preview1 후속·이벤트/구독3 보류 | **346 main**, 후보348 (+2, 공식 미반영) |
| I-30 | 계획 병합 완료 · 구현 전 | #297 MERGED f85cb51(독립3리뷰·날짜/채번 보완 R-1~R-14). 자식PR0·자기 브랜치 정리 | 증분0 (진행 예정8·보류1) |
