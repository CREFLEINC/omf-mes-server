...
| I-26 | 계획 #301·조회 #307·채번코어 #540 병합, POST 구현 진행 | 질의105 회신과 통보104·106·107 반영. 요청 N→개체 N, 실적/배분 선행0, `REGISTERED`, 전역 SN 묶음예약, 선택 If-Match 비교0, 실제 계정/사번/단말·멱등·충돌재시도 검증 | 구현 브랜치 458/487·발번 E2E9 pass |
