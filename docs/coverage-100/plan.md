...
**현재 목표 커버리지 479/487**(당초483 − I-28 본길 보류3 − I-30 완료 보류1). 배정/분모487은 불변이며 보류 해소 때 해당 증분만 복원한다. 최신 main 실측은 진행 기록과 병합 SHA로 구분한다(2026-09-07 8a895c2:348/487).
...
| I-30 | 계획 병합 완료 · ⓪ 준비 검증 완료 | #297 MERGED f85cb51. #300 달력일 helper156줄·신규47 tests·독립리뷰0·전체93/892 pass, 병합 대기. API① 이후 후속 | 증분0 (진행 예정8·보류1) |
