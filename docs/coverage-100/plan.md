...
**현재 목표 커버리지 478/487**(당초483 − I-28 본길 보류3 − I-30 완료 보류1 − I-26 발번 보류1). 배정/분모487은 불변이며 보류 해소 때 해당 증분만 복원한다. 최신 main 실측은 진행 기록과 병합 SHA로 구분한다(2026-09-07 eb42b21:348/487).
...
| I-30 | 계획·⓪ 준비 병합 완료 | #297 MERGED f85cb51. #300 MERGED eb42b21(달력일156줄·신규47 tests·독립리뷰0·전체93/892 pass). 열린자식0·자기브랜치정리, API① 이후 후속 | **348 main 실측**, 증분0 (진행 예정8·보류1) |
| I-26 | 계획 재수립 완료 · #301 병합 대기 | 독립3리뷰→R1~R10, 문의104~107. 조회1건 진행·발번1건 유보, 코드/마이그0 | 증분0·조회 예정+1 |
