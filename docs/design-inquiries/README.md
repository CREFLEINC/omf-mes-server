...
090~119는 B의 I-30/I-28/I-26/I-32/I-31/I-33 요청서로 작성됐다. 번호 대역은 `coverage-100/lanes.md` §1-1을 따른다. 계획 확정과 구현 완료는 각 행의 상태로 구분한다. B 추가 단건(수집채널 단위해제/import 실패집계, I27 후속)은 새 대역 사용자 승인 전 번호미배정이며 기존 번호에 무관한 물음을 합치지 않는다. 이 문서에서 새 대역을 배정하지 않는다.
