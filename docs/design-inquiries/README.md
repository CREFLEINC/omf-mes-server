...
⭐ **2026-09-09 — I-22(#409 · 원래 레인 C 것을 A 가 인수)가 `190`~`208` 열아홉을 배정받아 열아홉을 다 냈다.** 3관점 재검토가 낸 15건을 계획자 12건과 **중복 제거·병합**한 결과다 — **흡수 7**(통합ⓐ→190 · uiuxθ→192 · uiuxζ→193 · uiuxβ→195 · apiA-4+통합ⓑ→196 · uiuxδ→200 · apiA-8→201) · **신규 7**(202~208) · **유지 5**(191·194·197·198·199) · **강등 1**(권장 외 LOT 사유 → 「알려둘 것」). ⇒ **A 대역 잔여는 `209` 하나뿐이다.** 그 뒤는 사용자에게 새 대역을 받는다.
