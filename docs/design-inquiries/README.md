...
090~116는 B의 I-30/I-28/I-26/I-32/I-31 요청서로 작성됐다. 번호 대역은 `coverage-100/lanes.md` §1-1을 따른다. 계획 확정과 구현 완료는 각 행의 상태로 구분한다. 117~119는 I-33 통합용 예약, 이 문서에서 새 대역을 배정하지 않는다.
