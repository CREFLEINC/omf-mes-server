...
[[ -f "$SCRIPT_DIR/proxy/omf-api.conf" ]] || die "proxy/omf-api.conf를 설치 패키지에서 찾을 수 없습니다."
...
install -D -m 644 "$SCRIPT_DIR/proxy/omf-api.conf" "$APP_DIR/proxy/conf.d/omf-api.conf"
